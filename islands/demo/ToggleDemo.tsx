import {
  Toggle,
  toggleVariants,
} from 'https://deno.land/x/testing_shadcn_ui_for_deno@0.1.2/components/toggle.tsx'
...
const Code = `
import { Toggle } from 'https://deno.land/x/testing_shadcn_ui_for_deno@0.1.2/components/toggle.tsx'
