import {
  ...
  AvatarFallback,
  AvatarImage
} from 'https://deno.land/x/testing_shadcn_ui_for_deno@0.1.2/components/avatar.tsx'
import { Button } from 'https://deno.land/x/testing_shadcn_ui_for_deno@0.1.2/components/button.tsx'
import {
  HoverCard,
  HoverCardContent,
  HoverCardTrigger
} from 'https://deno.land/x/testing_shadcn_ui_for_deno@0.1.2/components/hover-card.tsx'
...
const Code = `
import { Avatar, AvatarFallback, AvatarImage } from 'https://deno.land/x/testing_shadcn_ui_for_deno@0.1.2/components/avatar.tsx'
import { Button } from 'https://deno.land/x/testing_shadcn_ui_for_deno@0.1.2/components/button.tsx'
import { HoverCard, HoverCardContent, HoverCardTrigger } from 'https://deno.land/x/testing_shadcn_ui_for_deno@0.1.2/components/hover-card.tsx'
import IconCalendarMonth from "https://deno.land/x/tabler_icons_tsx@0.0.7/tsx/calendar-month.tsx"
