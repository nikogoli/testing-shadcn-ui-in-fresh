import { isAny, isArbitraryLength, isArbitraryNumber, isArbitraryPosition, isArbitraryShadow, isArbitrarySize, isArbitraryUrl, isArbitraryValue, isInteger, isLength, isNumber, isPercent, isTshirtSize } from './validators.d.ts';
export declare function getDefaultConfig(): {
    ...
    readonly theme: {
        ...
        readonly borderColor: readonly [import("./types.d.ts").ThemeGetter];
        readonly borderRadius: readonly ["none", "", "full", typeof isTshirtSize, typeof isArbitraryValue];
        readonly borderSpacing: readonly [typeof isArbitraryValue, import("./types.d.ts").ThemeGetter];
        ...
        readonly gap: readonly [typeof isArbitraryValue, import("./types.d.ts").ThemeGetter];
        readonly gradientColorStops: readonly [import("./types.d.ts").ThemeGetter];
        readonly gradientColorStopPositions: readonly [typeof isPercent, typeof isArbitraryLength];
        readonly inset: readonly ["auto", typeof isArbitraryValue, import("./types.d.ts").ThemeGetter];
        readonly margin: readonly ["auto", typeof isArbitraryValue, import("./types.d.ts").ThemeGetter];
        readonly opacity: (typeof isNumber)[];
        readonly padding: readonly [typeof isArbitraryValue, import("./types.d.ts").ThemeGetter];
        ...
        readonly space: readonly [typeof isArbitraryValue, import("./types.d.ts").ThemeGetter];
        readonly translate: readonly [typeof isArbitraryValue, import("./types.d.ts").ThemeGetter];
    };
    readonly classGroups: {
        ...
        readonly inset: readonly [{
            readonly inset: readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Right / Left
         * @see https://tailwindcss.com/docs/top-right-bottom-left
        ...
        readonly 'inset-x': readonly [{
            readonly 'inset-x': readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Top / Bottom
         * @see https://tailwindcss.com/docs/top-right-bottom-left
        ...
        readonly 'inset-y': readonly [{
            readonly 'inset-y': readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Start
         * @see https://tailwindcss.com/docs/top-right-bottom-left
        ...
        readonly start: readonly [{
            readonly start: readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * End
         * @see https://tailwindcss.com/docs/top-right-bottom-left
        ...
        readonly end: readonly [{
            readonly end: readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Top
         * @see https://tailwindcss.com/docs/top-right-bottom-left
        ...
        readonly top: readonly [{
            readonly top: readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Right
         * @see https://tailwindcss.com/docs/top-right-bottom-left
        ...
        readonly right: readonly [{
            readonly right: readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Bottom
         * @see https://tailwindcss.com/docs/top-right-bottom-left
        ...
        readonly bottom: readonly [{
            readonly bottom: readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Left
         * @see https://tailwindcss.com/docs/top-right-bottom-left
        ...
        readonly left: readonly [{
            readonly left: readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Visibility
        ...
        readonly basis: readonly [{
            readonly basis: readonly ["auto", typeof isArbitraryValue, import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Flex Direction
        ...
        readonly gap: readonly [{
            readonly gap: readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Gap X
         * @see https://tailwindcss.com/docs/gap
        ...
        readonly 'gap-x': readonly [{
            readonly 'gap-x': readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Gap Y
         * @see https://tailwindcss.com/docs/gap
        ...
        readonly 'gap-y': readonly [{
            readonly 'gap-y': readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Justify Content
         ...
         */
        readonly p: readonly [{
            readonly p: readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Padding X
         * @see https://tailwindcss.com/docs/padding
        ...
        readonly px: readonly [{
            readonly px: readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Padding Y
         * @see https://tailwindcss.com/docs/padding
        ...
        readonly py: readonly [{
            readonly py: readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Padding Start
         * @see https://tailwindcss.com/docs/padding
        ...
        readonly ps: readonly [{
            readonly ps: readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Padding End
         * @see https://tailwindcss.com/docs/padding
        ...
        readonly pe: readonly [{
            readonly pe: readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Padding Top
         * @see https://tailwindcss.com/docs/padding
        ...
        readonly pt: readonly [{
            readonly pt: readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Padding Right
         * @see https://tailwindcss.com/docs/padding
        ...
        readonly pr: readonly [{
            readonly pr: readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Padding Bottom
         * @see https://tailwindcss.com/docs/padding
        ...
        readonly pb: readonly [{
            readonly pb: readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Padding Left
         * @see https://tailwindcss.com/docs/padding
        ...
        readonly pl: readonly [{
            readonly pl: readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Margin
         ...
         */
        readonly m: readonly [{
            readonly m: readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Margin X
         * @see https://tailwindcss.com/docs/margin
        ...
        readonly mx: readonly [{
            readonly mx: readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Margin Y
         * @see https://tailwindcss.com/docs/margin
        ...
        readonly my: readonly [{
            readonly my: readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Margin Start
         * @see https://tailwindcss.com/docs/margin
        ...
        readonly ms: readonly [{
            readonly ms: readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Margin End
         * @see https://tailwindcss.com/docs/margin
        ...
        readonly me: readonly [{
            readonly me: readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Margin Top
         * @see https://tailwindcss.com/docs/margin
        ...
        readonly mt: readonly [{
            readonly mt: readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Margin Right
         * @see https://tailwindcss.com/docs/margin
        ...
        readonly mr: readonly [{
            readonly mr: readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Margin Bottom
         * @see https://tailwindcss.com/docs/margin
        ...
        readonly mb: readonly [{
            readonly mb: readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Margin Left
         * @see https://tailwindcss.com/docs/margin
        ...
        readonly ml: readonly [{
            readonly ml: readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Space Between X
        ...
        readonly 'space-x': readonly [{
            readonly 'space-x': readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
        ...
        readonly 'space-y': readonly [{
            readonly 'space-y': readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         ...
         */
        readonly w: readonly [{
            readonly w: readonly ["auto", "min", "max", "fit", typeof isArbitraryValue, import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Min-Width
         ...
         */
        readonly h: readonly [{
            readonly h: readonly [typeof isArbitraryValue, import("./types.d.ts").ThemeGetter, "auto", "min", "max", "fit"];
        }];
        /**
         * Min-Height
        ...
        readonly 'max-h': readonly [{
            readonly 'max-h': readonly [typeof isArbitraryValue, import("./types.d.ts").ThemeGetter, "min", "max", "fit"];
        }];
        /**
         * Font Size
        ...
        readonly 'placeholder-color': readonly [{
            readonly placeholder: readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Placeholder Opacity
        ...
        readonly 'placeholder-opacity': readonly [{
            readonly 'placeholder-opacity': readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Text Alignment
        ...
        readonly 'text-color': readonly [{
            readonly text: readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Text Opacity
        ...
        readonly 'text-opacity': readonly [{
            readonly 'text-opacity': readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Text Decoration
        ...
        readonly 'text-decoration-color': readonly [{
            readonly decoration: readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Text Transform
        ...
        readonly indent: readonly [{
            readonly indent: readonly [typeof isArbitraryValue, import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Vertical Alignment
        ...
        readonly 'bg-opacity': readonly [{
            readonly 'bg-opacity': readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Background Origin
        ...
        readonly 'bg-color': readonly [{
            readonly bg: readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
        ...
        readonly 'gradient-from-pos': readonly [{
            readonly from: readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
        ...
        readonly 'gradient-via-pos': readonly [{
            readonly via: readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
        ...
        readonly 'gradient-to-pos': readonly [{
            readonly to: readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
        ...
        readonly rounded: readonly [{
            readonly rounded: readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Border Radius Start
         * @see https://tailwindcss.com/docs/border-radius
        ...
        readonly 'rounded-s': readonly [{
            readonly 'rounded-s': readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Border Radius End
         * @see https://tailwindcss.com/docs/border-radius
        ...
        readonly 'rounded-e': readonly [{
            readonly 'rounded-e': readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Border Radius Top
         * @see https://tailwindcss.com/docs/border-radius
        ...
        readonly 'rounded-t': readonly [{
            readonly 'rounded-t': readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Border Radius Right
         * @see https://tailwindcss.com/docs/border-radius
        ...
        readonly 'rounded-r': readonly [{
            readonly 'rounded-r': readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
        ...
        readonly 'rounded-b': readonly [{
            readonly 'rounded-b': readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Border Radius Left
         * @see https://tailwindcss.com/docs/border-radius
        ...
        readonly 'rounded-l': readonly [{
            readonly 'rounded-l': readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
        ...
        readonly 'rounded-ss': readonly [{
            readonly 'rounded-ss': readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
        ...
        readonly 'rounded-se': readonly [{
            readonly 'rounded-se': readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
        ...
        readonly 'rounded-ee': readonly [{
            readonly 'rounded-ee': readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
        ...
        readonly 'rounded-es': readonly [{
            readonly 'rounded-es': readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
        ...
        readonly 'rounded-tl': readonly [{
            readonly 'rounded-tl': readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
        ...
        readonly 'rounded-tr': readonly [{
            readonly 'rounded-tr': readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
        ...
        readonly 'rounded-br': readonly [{
            readonly 'rounded-br': readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
        ...
        readonly 'rounded-bl': readonly [{
            readonly 'rounded-bl': readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Border Width
        ...
        readonly 'border-w': readonly [{
            readonly border: readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Border Width X
         * @see https://tailwindcss.com/docs/border-width
        ...
        readonly 'border-w-x': readonly [{
            readonly 'border-x': readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Border Width Y
         * @see https://tailwindcss.com/docs/border-width
        ...
        readonly 'border-w-y': readonly [{
            readonly 'border-y': readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Border Width Start
         * @see https://tailwindcss.com/docs/border-width
        ...
        readonly 'border-w-s': readonly [{
            readonly 'border-s': readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Border Width End
         * @see https://tailwindcss.com/docs/border-width
        ...
        readonly 'border-w-e': readonly [{
            readonly 'border-e': readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Border Width Top
         * @see https://tailwindcss.com/docs/border-width
        ...
        readonly 'border-w-t': readonly [{
            readonly 'border-t': readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Border Width Right
         * @see https://tailwindcss.com/docs/border-width
        ...
        readonly 'border-w-r': readonly [{
            readonly 'border-r': readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Border Width Bottom
         * @see https://tailwindcss.com/docs/border-width
        ...
        readonly 'border-w-b': readonly [{
            readonly 'border-b': readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Border Width Left
         * @see https://tailwindcss.com/docs/border-width
        ...
        readonly 'border-w-l': readonly [{
            readonly 'border-l': readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Border Opacity
        ...
        readonly 'border-opacity': readonly [{
            readonly 'border-opacity': readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Border Style
        ...
        readonly 'divide-x': readonly [{
            readonly 'divide-x': readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
        ...
        readonly 'divide-y': readonly [{
            readonly 'divide-y': readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
        ...
        readonly 'divide-opacity': readonly [{
            readonly 'divide-opacity': readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Divide Style
        ...
        readonly 'divide-color': readonly [{
            readonly divide: readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Outline Style
        ...
        readonly 'outline-color': readonly [{
            readonly outline: readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Ring Width
        ...
        readonly 'ring-color': readonly [{
            readonly ring: readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Ring Opacity
        ...
        readonly 'ring-opacity': readonly [{
            readonly 'ring-opacity': readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Ring Offset Width
        ...
        readonly 'ring-offset-color': readonly [{
            readonly 'ring-offset': readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Box Shadow
        ...
        readonly opacity: readonly [{
            readonly opacity: readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Mix Blend Mode
        ...
        readonly blur: readonly [{
            readonly blur: readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Brightness
        ...
        readonly brightness: readonly [{
            readonly brightness: readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Contrast
        ...
        readonly contrast: readonly [{
            readonly contrast: readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Drop Shadow
        ...
        readonly grayscale: readonly [{
            readonly grayscale: readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Hue Rotate
        ...
        readonly 'hue-rotate': readonly [{
            readonly 'hue-rotate': readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Invert
        ...
        readonly invert: readonly [{
            readonly invert: readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Saturate
        ...
        readonly saturate: readonly [{
            readonly saturate: readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Sepia
        ...
        readonly sepia: readonly [{
            readonly sepia: readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Backdrop Filter
         * @deprecated since Tailwind CSS v3.0.0
        ...
        readonly 'backdrop-blur': readonly [{
            readonly 'backdrop-blur': readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Backdrop Brightness
        ...
        readonly 'backdrop-brightness': readonly [{
            readonly 'backdrop-brightness': readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Backdrop Contrast
        ...
        readonly 'backdrop-contrast': readonly [{
            readonly 'backdrop-contrast': readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Backdrop Grayscale
        ...
        readonly 'backdrop-grayscale': readonly [{
            readonly 'backdrop-grayscale': readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Backdrop Hue Rotate
        ...
        readonly 'backdrop-hue-rotate': readonly [{
            readonly 'backdrop-hue-rotate': readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Backdrop Invert
        ...
        readonly 'backdrop-invert': readonly [{
            readonly 'backdrop-invert': readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Backdrop Opacity
        ...
        readonly 'backdrop-opacity': readonly [{
            readonly 'backdrop-opacity': readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Backdrop Saturate
        ...
        readonly 'backdrop-saturate': readonly [{
            readonly 'backdrop-saturate': readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Backdrop Sepia
        ...
        readonly 'backdrop-sepia': readonly [{
            readonly 'backdrop-sepia': readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Border Collapse
        ...
        readonly 'border-spacing': readonly [{
            readonly 'border-spacing': readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Border Spacing X
         * @see https://tailwindcss.com/docs/border-spacing
        ...
        readonly 'border-spacing-x': readonly [{
            readonly 'border-spacing-x': readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Border Spacing Y
         * @see https://tailwindcss.com/docs/border-spacing
        ...
        readonly 'border-spacing-y': readonly [{
            readonly 'border-spacing-y': readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Table Layout
        ...
        readonly scale: readonly [{
            readonly scale: readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Scale X
         * @see https://tailwindcss.com/docs/scale
        ...
        readonly 'scale-x': readonly [{
            readonly 'scale-x': readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Scale Y
         * @see https://tailwindcss.com/docs/scale
        ...
        readonly 'scale-y': readonly [{
            readonly 'scale-y': readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Rotate
        ...
        readonly 'translate-x': readonly [{
            readonly 'translate-x': readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Translate Y
         * @see https://tailwindcss.com/docs/translate
        ...
        readonly 'translate-y': readonly [{
            readonly 'translate-y': readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Skew X
        ...
        readonly 'skew-x': readonly [{
            readonly 'skew-x': readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Skew Y
         * @see https://tailwindcss.com/docs/skew
        ...
        readonly 'skew-y': readonly [{
            readonly 'skew-y': readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Transform Origin
        ...
        readonly accent: readonly [{
            readonly accent: readonly ["auto", import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Appearance
        ...
        readonly 'caret-color': readonly [{
            readonly caret: readonly [import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Pointer Events
        ...
        readonly 'scroll-m': readonly [{
            readonly 'scroll-m': readonly [typeof isArbitraryValue, import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Scroll Margin X
         * @see https://tailwindcss.com/docs/scroll-margin
        ...
        readonly 'scroll-mx': readonly [{
            readonly 'scroll-mx': readonly [typeof isArbitraryValue, import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Scroll Margin Y
         * @see https://tailwindcss.com/docs/scroll-margin
        ...
        readonly 'scroll-my': readonly [{
            readonly 'scroll-my': readonly [typeof isArbitraryValue, import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Scroll Margin Start
         * @see https://tailwindcss.com/docs/scroll-margin
        ...
        readonly 'scroll-ms': readonly [{
            readonly 'scroll-ms': readonly [typeof isArbitraryValue, import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Scroll Margin End
         * @see https://tailwindcss.com/docs/scroll-margin
        ...
        readonly 'scroll-me': readonly [{
            readonly 'scroll-me': readonly [typeof isArbitraryValue, import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Scroll Margin Top
         * @see https://tailwindcss.com/docs/scroll-margin
        ...
        readonly 'scroll-mt': readonly [{
            readonly 'scroll-mt': readonly [typeof isArbitraryValue, import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Scroll Margin Right
         * @see https://tailwindcss.com/docs/scroll-margin
        ...
        readonly 'scroll-mr': readonly [{
            readonly 'scroll-mr': readonly [typeof isArbitraryValue, import("./types.d.ts").ThemeGetter];
        }];
        /**
        ...
        readonly 'scroll-mb': readonly [{
            readonly 'scroll-mb': readonly [typeof isArbitraryValue, import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Scroll Margin Left
         * @see https://tailwindcss.com/docs/scroll-margin
        ...
        readonly 'scroll-ml': readonly [{
            readonly 'scroll-ml': readonly [typeof isArbitraryValue, import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Scroll Padding
        ...
        readonly 'scroll-p': readonly [{
            readonly 'scroll-p': readonly [typeof isArbitraryValue, import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Scroll Padding X
         * @see https://tailwindcss.com/docs/scroll-padding
        ...
        readonly 'scroll-px': readonly [{
            readonly 'scroll-px': readonly [typeof isArbitraryValue, import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Scroll Padding Y
         * @see https://tailwindcss.com/docs/scroll-padding
        ...
        readonly 'scroll-py': readonly [{
            readonly 'scroll-py': readonly [typeof isArbitraryValue, import("./types.d.ts").ThemeGetter];
        }];
        /**
        ...
        readonly 'scroll-ps': readonly [{
            readonly 'scroll-ps': readonly [typeof isArbitraryValue, import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Scroll Padding End
         * @see https://tailwindcss.com/docs/scroll-padding
        ...
        readonly 'scroll-pe': readonly [{
            readonly 'scroll-pe': readonly [typeof isArbitraryValue, import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Scroll Padding Top
         * @see https://tailwindcss.com/docs/scroll-padding
        ...
        readonly 'scroll-pt': readonly [{
            readonly 'scroll-pt': readonly [typeof isArbitraryValue, import("./types.d.ts").ThemeGetter];
        }];
        /**
        ...
        readonly 'scroll-pr': readonly [{
            readonly 'scroll-pr': readonly [typeof isArbitraryValue, import("./types.d.ts").ThemeGetter];
        }];
        /**
        ...
        readonly 'scroll-pb': readonly [{
            readonly 'scroll-pb': readonly [typeof isArbitraryValue, import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Scroll Padding Left
         * @see https://tailwindcss.com/docs/scroll-padding
        ...
        readonly 'scroll-pl': readonly [{
            readonly 'scroll-pl': readonly [typeof isArbitraryValue, import("./types.d.ts").ThemeGetter];
        }];
        /**
         * Scroll Snap Align
        ...
        readonly fill: readonly [{
            readonly fill: readonly [import("./types.d.ts").ThemeGetter, "none"];
        }];
        /**
         * Stroke Width
        ...
        readonly stroke: readonly [{
            readonly stroke: readonly [import("./types.d.ts").ThemeGetter, "none"];
        }];
        /**
         * Screen Readers
