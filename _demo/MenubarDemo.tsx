...
import {
  ...
  MenubarSubTrigger,
  MenubarTrigger,
} from 'https://deno.land/x/testing_shadcn_ui_for_deno@0.1.1/components/menubar.tsx'
...
export function MenubarDemo() {
  const createComp = async () => {
    const {
      ...
      MenubarSubTrigger,
      MenubarTrigger,
    } = await import('https://deno.land/x/testing_shadcn_ui_for_deno@0.1.1/components/menubar.tsx')
