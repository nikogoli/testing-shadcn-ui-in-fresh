...
import {
  ...
  DialogTitle,
  DialogTrigger,
} from 'https://deno.land/x/testing_shadcn_ui_for_deno@0.0.5/components/dialog.tsx'
import { Input } from 'https://deno.land/x/testing_shadcn_ui_for_deno@0.0.5/components/input.tsx'
