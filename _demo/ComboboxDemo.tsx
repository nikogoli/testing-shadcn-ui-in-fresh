...
import {
  ...
  PopoverContent,
  PopoverTrigger,
} from "https://deno.land/x/testing_shadcn_ui_for_deno@0.1.1/components/popover.tsx"
...
export function ComboboxDemo() {
  const createComp = async () => {
    const { default: IconCheck } = await import("https://deno.land/x/tabler_icons_tsx@0.0.5/tsx/check.tsx")
    const { default: IconBracketsAngle } = await import("https://deno.land/x/tabler_icons_tsx@0.0.5/tsx/brackets-angle.tsx")
    ...
    const {
      ...
      PopoverContent,
      PopoverTrigger,
    } = await import("https://deno.land/x/testing_shadcn_ui_for_deno@0.1.1/components/popover.tsx")
