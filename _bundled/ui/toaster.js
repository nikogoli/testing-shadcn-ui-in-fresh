...
function Toaster() {
  ...
  return /* @__PURE__ */ g3(ToastProvider, { children: [
    toasts.map(function({ id, title, description, action, ...props }) {
      return /* @__PURE__ */ g3(Toast, { ...props, children: [
        /* @__PURE__ */ g3("div", { class: "grid gap-1", children: [
          title && /* @__PURE__ */ g3(ToastTitle, { children: title }),
          description && /* @__PURE__ */ g3(ToastDescription, { children: description })
        ] }),
        action,
        /* @__PURE__ */ g3(ToastClose, {})
      ] }, id);
    }),
    /* @__PURE__ */ g3(ToastViewport, {})
  ] });
}
export {
  Toaster
