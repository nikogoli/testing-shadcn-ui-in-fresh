...
function br(r) {
  ...
  return function(n) {
    for (var i2 = [], c = 0, u = 0, b2, f = 0; f < n.length; f++) {
      var g2 = n[f];
      if (c === 0) {
    ...
    var y = i2.length === 0 ? n : n.substring(u), x3 = y.startsWith(X), m = x3 ? y.substring(1) : y, w2 = b2 && b2 > u ? b2 - u : void 0;
    return { modifiers: i2, hasImportantModifier: x3, baseClassName: m, maybePostfixModifierPosition: w2 };
  };
}
function gr(r) {
  if (r.length <= 1)
...
function vr(r, e2) {
  ...
  return r.trim().split(Ir).map(function(n) {
    var i2 = t(n), c = i2.modifiers, u = i2.hasImportantModifier, b2 = i2.baseClassName, f = i2.maybePostfixModifierPosition, g2 = o2(f ? b2.substring(0, f) : b2), y = !!f;
    if (!g2) {
      if (!f)
    ...
    var x3 = gr(c).join(":"), m = u ? x3 + X : x3;
    return { isTailwindClass: true, modifierId: m, classGroupId: g2, originalClassName: n, hasPostfixModifier: y };
  }).reverse().filter(function(n) {
    if (!n.isTailwindClass)
      return true;
    var i2 = n.modifierId, c = n.classGroupId, u = n.hasPostfixModifier, b2 = i2 + c;
    return s.has(b2) ? false : (s.add(b2), a2(c, u).forEach(function(f) {
      return s.add(i2 + f);
    }), true);
...
function P() {
  ...
  var o2, a2, s, n = i2;
  function i2(u) {
    var b2 = e2[0], f = e2.slice(1), g2 = f.reduce(function(y, x3) {
      return x3(y);
    }, b2());
...
function ie(e2, _, t) {
  ...
  if (l2)
    return (i2 = b({}, n)).__v = n.__v + 1, a.vnode && a.vnode(i2), G2(l2, i2, n, e2.__n, l2.ownerSVGElement !== void 0, 32 & n.__u ? [r] : null, _, r ?? w(n), !!(32 & n.__u), t), i2.__v = n.__v, i2.__.__k[i2.__i] = i2, i2.__d = void 0, i2.__e != r && ee(i2), i2;
}
function ee(e2) {
  var _, t;
...
function _e(e2, _, t, i2, n, r, l2, u, c, s, p) {
  var o2, m, f, h2, k, v = i2 && i2.__k || O, d3 = _.length;
  for (t.__d = c, le(t, _, v), c = t.__d, o2 = 0; o2 < d3; o2++)
    (f = t.__k[o2]) != null && typeof f != "boolean" && typeof f != "function" && (m = f.__i === -1 ? E : v[f.__i] || E, f.__i = o2, G2(e2, f, m, n, r, l2, u, c, s, p), h2 = f.__e, f.ref && m.ref != f.ref && (m.ref && V2(m.ref, null, f), p.push(f.ref, f.__c || h2, f)), k == null && h2 != null && (k = h2), 65536 & f.__u || m.__k === f.__k ? c = te(f, c, e2) : typeof f.type == "function" && f.__d !== void 0 ? c = f.__d : h2 && (c = h2.nextSibling), f.__d = void 0, f.__u &= -196609);
  t.__d = c, t.__e = k;
}
function le(e2, _, t) {
...
function G2(e2, _, t, i2, n, r, l2, u, c, s) {
  var p, o2, m, f, h2, k, v, d3, y, C2, T2, P2, j, U2, N, g2 = _.type;
  ...
  e:
    if (typeof g2 == "function")
      try {
        if (d3 = _.props, y = (p = g2.contextType) && i2[p.__c], C2 = p ? y ? y.props.value : p.__ : i2, t.__c ? v = (o2 = _.__c = t.__c).__ = o2.__E : ("prototype" in g2 && g2.prototype.render ? _.__c = o2 = new g2(d3, C2) : (_.__c = o2 = new W(d3, C2), o2.constructor = g2, o2.render = ce), y && y.sub(o2), o2.props = d3, o2.state || (o2.state = {}), o2.context = C2, o2.__n = i2, m = o2.__d = true, o2.__h = [], o2._sb = []), o2.__s == null && (o2.__s = o2.state), g2.getDerivedStateFromProps != null && (o2.__s == o2.state && (o2.__s = b({}, o2.__s)), b(o2.__s, g2.getDerivedStateFromProps(d3, o2.__s))), f = o2.props, h2 = o2.state, o2.__v = _, m)
        ...
        if (o2.context = C2, o2.props = d3, o2.__P = e2, o2.__e = false, P2 = a.__r, j = 0, "prototype" in g2 && g2.prototype.render) {
          ...
          while (o2.__d && ++j < 25);
        o2.state = o2.__s, o2.getChildContext != null && (i2 = b(b({}, i2), o2.getChildContext())), m || o2.getSnapshotBeforeUpdate == null || (k = o2.getSnapshotBeforeUpdate(f, h2)), _e(e2, F(N = p != null && p.type === H2 && p.key == null ? p.props.children : p) ? N : [N], _, t, i2, n, r, l2, u, c, s), o2.base = _.__e, _.__u &= -161, o2.__h.length && l2.push(o2), v && (o2.__E = o2.__ = null);
      } catch (L2) {
...
function fe(e2, _, t, i2, n, r, l2, u, c) {
  var s, p, o2, m, f, h2, k, v = t.props, d3 = _.props, y = _.type;
  if (y === "svg" && (n = true), r != null) {
  ...
  if (e2 == null) {
    ...
    e2 = n ? document.createElementNS("http://www.w3.org/2000/svg", y) : document.createElement(y, d3.is && d3), r = null, u = false;
  }
  if (y === null)
    ...
    for (s in d3)
      f = d3[s], s == "children" ? m = f : s == "dangerouslySetInnerHTML" ? p = f : s == "value" ? h2 = f : s == "checked" ? k = f : s === "key" || u && typeof f != "function" || v[s] === f || M2(e2, s, f, v[s], n);
    if (p)
      u || o2 && (p.__html === o2.__html || p.__html === e2.innerHTML) || (e2.innerHTML = p.__html), _.__k = [];
    else if (o2 && (e2.innerHTML = ""), _e(e2, F(m) ? m : [m], _, t, i2, n && y !== "foreignObject", r, l2, r ? r[0] : t.__k && w(t, 0), u, c), r != null)
      for (s = r.length; s--; )
        r[s] != null && Z2(r[s]);
    u || (s = "value", h2 !== void 0 && (h2 !== e2[s] || y === "progress" && !h2 || y === "option" && h2 !== v[s]) && M2(e2, s, h2, v[s], false), s = "checked", k !== void 0 && k !== e2[s] && M2(e2, s, k, v[s], false));
  }
  return e2;
}
function V2(e2, _, t) {
...
D2 = O.slice, a = { __e: function(e2, _, t, i2) {
  ...
  var t;
  t = this.__s != null && this.__s !== this.state ? this.__s : this.__s = b({}, this.state), typeof e2 == "function" && (e2 = e2(b({}, t), this.props)), e2 && b(t, e2), e2 != null && this.__v && (_ && this._sb.push(_), I2(this));
...
function Skeleton({ class: className, ...props }) {
  return /* @__PURE__ */ g("div", { className: cn("animate-pulse rounded-md bg-muted", className), ...props });
}
export {
  Skeleton
};
